...
enum TimeQuestSchemaV5: VersionedSchema {
    nonisolated(unsafe) static var versionIdentifier = Schema.Version(5, 0, 0)
    ...
    final class Routine {
        ...
        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV5.RoutineTask.routine)
        var tasks: [RoutineTask] = []

        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV5.GameSession.routine)
    ...
    final class GameSession {
        ...
        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV5.TaskEstimation.session)
