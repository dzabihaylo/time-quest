...
enum TimeQuestSchemaV3: VersionedSchema {
    ...
    final class Routine {
        ...
        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV3.RoutineTask.routine)
        var tasks: [RoutineTask] = []

        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV3.GameSession.routine)
    ...
    final class GameSession {
        ...
        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV3.TaskEstimation.session)
