...
enum TimeQuestSchemaV4: VersionedSchema {
    ...
    final class Routine {
        ...
        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV4.RoutineTask.routine)
        var tasks: [RoutineTask] = []

        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV4.GameSession.routine)
    ...
    final class GameSession {
        ...
        @Relationship(deleteRule: .cascade, inverse: \TimeQuestSchemaV4.TaskEstimation.session)
