...
All structs must be sendable-safe (pure value types, no mutable state). Match the coding style of TimeEstimationScorer.swift exactly.
  ...
  <verify>
Build the project: `cd "/Users/davezabihaylo/Documents/Projects/time-quest/TimeQuest" && xcodebuild -scheme TimeQuest -destination 'platform=iOS Simulator,name=iPhone 16,OS=18.2' build 2>&1 | tail -20`
