...
Then regenerate the project: `cd /Users/davezabihaylo/Documents/Projects/time-quest && node generate-xcodeproj.js`
...
- Verify build: `cd /Users/davezabihaylo/Documents/Projects/time-quest/TimeQuest && xcodebuild build -scheme TimeQuest -destination 'platform=iOS Simulator,name=iPhone 16' -quiet 2>&1 | tail -5`
  </verify>
  <done>
