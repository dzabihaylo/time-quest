...
- [ ] **Phase 7: Schema Evolution + Adaptive Difficulty** - Game automatically calibrates challenge level per task based on accuracy history
- [ ] **Phase 8: Calendar Intelligence** - Routines surface and hide based on the player's real-world schedule
...
| 8. Calendar Intelligence | v3.0 | 0/TBD | Not started | - |
